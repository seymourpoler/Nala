...
namespace Nala.Framework.Unit.Test
{
    public class Expect_should
    {
        ...
        [Fact]
        public void do_nothing_when_is_not_greater_than()
        {
            new Expected<int>(2).Not.ToBeGreaterThan(2);
        }
        
        [Fact]
        public void throw_exception_when_is_greater_than()
        {
            Action action = () =>
            {
                new Expected<int>(7).Not.ToBeGreaterThan(3);
            };
        ...
        [Fact]
        public void do_nothing_when_is_less_than()
        {
            new Expected<int>(2).ToBeLessThan(7);
        }
        
        [Fact]
        public void throw_exception_when_is_not_less_than()
        {
            Action action = () =>
            {
                new Expected<int>(2).ToBeLessThan(2);
            };
        ...
        [Fact]
        public void throw_exception_when_is_less_than()
        {
            Action action = () =>
            {
                new Expected<int>(5).Not.ToBeLessThan(7);
            };
